            ...
            <div class="row border-top mt-2 align-items-center py-1">
                ...
                <div class="col-2 col-md-3">
                    <div
                        ...
                        <a class="btn btn-success rounded-circle border bnb-btn-shadow bnb-btn-actions"
                        ...
                        <a class="btn btn-primary rounded-circle border bnb-btn-shadow bnb-btn-actions"
                        ...
                        <a class="btn btn-warning rounded-circle border bnb-btn-shadow bnb-btn-actions"
                        ...
                        <!-- MODAL DELETE -->
                        <button type="button" class="btn btn-danger rounded-circle border bnb-btn-shadow bnb-btn-actions"
            ...
            @forelse ($apartments as $apartment)
                <div class="card border-0 border-top rounded-0">
                    <div class="card-body row row-cols-1 row-cols-md-5 justify-content-between px-0">
                        ...
                        <div class="d-flex flex-column align-items-center align-content-end gap-1"> justify-content-xsm-center  justify-content-end 
                            <a class="btn btn-light rounded-circle border bnb-btn-shadow bnb-btn-actions"
                                href="{{ route('admin.apartments.show', $apartment->id) }}" role="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-eye-fill" viewBox="0 0 16 16">
                            ...
                            <a class="btn btn-primary rounded-circle border bnb-btn-shadow me-1 bnb-btn-actions"
                                href="{{ route('admin.apartments.sponsorships.index', $apartment) }}" role="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-currency-dollar" viewBox="0 0 16 16">
                                    <path
